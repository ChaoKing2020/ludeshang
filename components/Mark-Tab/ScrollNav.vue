...
.component-view-scroll-nav
	...
	.navbar
		overflow auto;display flex;width 100%;height 70rpx;position relative;background-color #fff;border-bottom 1px solid rgba(39,40,50,0.1);border-top 1px solid rgba(39,40,50,0.1);
		.nav-wrapper
			display flex;position relative;width 100%;justify-content center; align-items center;height 100%;
			.line
