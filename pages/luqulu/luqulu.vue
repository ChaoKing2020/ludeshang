<template>
	<view class="">
		...
		<!-- 这里是状态栏 -->
		<uni-nav-bar title="测录取率" backgroundColor='#b50e03' color='#fff461' left-text="返回" @clickLeft="clickBack" />
	<view class="content">
		<view class="form">
			<uni-forms :modelValue="formData" :rules="formRules" ref="form">
				<uni-forms-item required name="school" label="心仪院校">
		...
		<view class="Lists">
			<yx-list :schoolList="schoolLists" :type="type" ></yx-list>
		</view>
	</view>
	</view>
</template>
