<template>
	<view class="">
		...
		<!-- 这里是状态栏 -->
		<uni-nav-bar title="招生计划" backgroundColor='#b50e03' color='#fff461' left-text="返回" @clickLeft="clickBack" />
	<view class="content">
		<view class="form">
		...
		<view class="Lists">
			<yx-list :schoolList="schoolLists" :zscolor='true'></yx-list>
		</view>
	</view>
	</view>
</template>
